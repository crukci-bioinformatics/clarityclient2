...
public class DemuxArtifactSample extends LimsEntityLinkBase<Sample>
{
     ...
     */
    @Serial private static final long serialVersionUID = 7139520312009522858L;
     ...
     */
    public DemuxArtifactSample(URI uri, String limsid)
    {
        this.uri = uri;
        this.limsid = limsid;
    }
     ...
     */
    public DemuxArtifactSample(Linkable<Sample> link)
    {
     ...
     */
    public DemuxArtifactSample(LimsEntityLinkable<Sample> link)
    {
        requireNonNull(link, "link cannot be null");
        uri = link.getUri();
